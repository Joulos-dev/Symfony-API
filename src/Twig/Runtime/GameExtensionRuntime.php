...
class GameExtensionRuntime implements RuntimeExtensionInterface
{
    ...
    public function getRatingStars(): string
    {
       $emptyStars = '';
        for($i=0; $i < 5; $i++) {
            $emptyStars .= '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
